...
-- Query 6 Alternative with Merge Join:
SELECT /*+ USE_MERGE(v t e p r) */
    v.visitor_id,
    v.first_name,
    v.last_name,
    e.event_id,
...
-- Query 6 Alternative with Hybrid Strategy – Leading and Join
SELECT /*+ LEADING(v t e p r) USE_HASH(t e p r) */
    v.visitor_id,
    v.first_name,
    v.last_name,
    e.event_id,
